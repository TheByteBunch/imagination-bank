import json
def main():
    account_name,account_balance,answer=create_account()
    account_name,account_balance=login_user(account_name,account_balance,answer)
    while True:
...
def create_account():
    ...
    return account_name,account_balance,answer
def login_user(account_name,account_balance,answer):
    while True:
        if answer=="N":
            break
        elif answer=="Y":
